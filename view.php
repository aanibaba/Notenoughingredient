 ...
 while($row=mysql_fetch_array($result_set))
 {
  ?>
	...
	<td><img style="width:400px;" src="uploads/<?php echo $row['file'] ?>" ></td>
        ...
        <table style="max-width:800px;margin:0 auto; text-align:justify;margin-top:20px;margin-bottom:20px;">
        <tr><td class="recipecat"><p class="recipetxt">Preperation Time</p><?php echo $row['ti'] ?></td><td class="recipecat"><p class="recipetxt">Cooking Time</p><?php echo $row['cooktime'] ?></td><td class="recipecat"><p class="recipetxt">Category</p><?php echo $row['category'] ?></td></tr>
        </table>
        <table class="recipedesc">
