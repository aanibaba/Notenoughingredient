...
<table width="309" align="center" cellpadding="2" cellspacing="5">
  <tr>
    <td style="font-size:20px;border:0;color:#FF7B74;text-align:center;font-weight:bold" colspan="2">
  ...
  <tr>
    <td style="width:116px;background:#FF7B74;color:white"><div align="right">Username</div></td>
    <td width="177"><input name="username" type="text" /></td>
  </tr>
  <tr>
    <td style="width:116px;background:#FF7B74;color:white"><div align="right">Password</div></td>
    <td><input name="password" type="password" /></td>
  </tr>
  
</table>
<p style="float:right;"><input style="float:right;width:150px" name="" type="submit" value="login" /></p>
