...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=946445645448914";
...
<div id="fb-root"></div>
	...
	<header class="head" role="banner">
		...
		<div class="wrap clearfix">
			<a href="index.php" title="Recipes" class="logo"><img src="images/ico/logo.png" alt="Recipes logo" /></a>
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					...
					<li><a href="pantry.php" title="Features"><span>Pantry</span></a>
					</li>
...
<a href="https://twitter.com/share" class="twitter-share-button" data-via="Bala2ky1" data-size="large" data-count="none" data-dnt="true">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></div>
			<nav class="user-nav" role="navigation">
				<ul>
					<li class="light"><a href="recipesearch.php" title="Search for recipes"><i class="ico i-search"></i> <span>Search for recipes</span></a></li>
					<li class="medium"><a href="Myprofile.php" title="My account"><i class="ico i-account"></i> <span>My account</span></a></li>
					<li class="dark"><a href="recipesubmit.php" title="Submit a recipe"><i class="ico i-submitrecipe"></i> <span>Submit a recipe</span></a></li>
	...
	<main class="main" role="main">
		<!--intro-->
		<div class="intro">
		<!--	<figure class="bg"><img src="images/intro.jpg" alt="" /></figure> spaghetti background picture-->
			<figure class="bg"><img src="http://www.taketheirbreathaway.com/wp-content/uploads/2015/06/EnF7DhHROS8OMEp2pCkx_Dufer-food-overhead-hig-res.jpg" alt="" /></figure>
			...
			<div class="wrap clearfix">
				...
				<div class="row">
					<article class="three-fourth text wow zoomIn" data-wow-delay=".2s">
						<h1>Recipe Web Service!</h1>
						<p>Recipes search engine by ingredients you have at home</strong>, where recipes come to life. Wanna know what you will gain by creating a personal pantry account?</p>
						<p>You can make recipe straight from the pantry</p>
						<a href="register.php" class="button white more medium">Create An Account</a>
					...
					<div class="one-fourth wow fadeInDown" data-wow-delay=".5s">
						<div class="widget container">
							<div class="textwrap">
								...
								<p>All you need to do is select an igredient</p>
...
<input type="submit" value="Quick Recipe" />
</div>
</form>
		...
		<div class="wrap clearfix">
							...
							<div class="featured two-third wow fadeInLeft">
								...
								<article class="entry">
									<figure>
										...
										<img src="http://www.trulytreats.com/communities/8/004/008/111/168//images/4604400042.jpg" alt="" /> <!-- Honey Cake Recipe of The Day-->
			...
			<div class="cwrap">
						<!-- Past Recipes Section 
							<header class="s-title">
							<h2 class="ribbon bright">Past Recipes</h2>
						</header> -->
 <!-- Past Recipes Call Function
 <?php
...
$link_address = 'members_recipe.php';
$link_address1 = 'hometest.php';
if ($result->num_rows > 0) {
    // output data of each row
    
    while($row = $result->fetch_assoc()) {
    	echo "<table style='position:relative;float:left;width:250px;'><tr><td>";
	echo "<table class='recipetable1'>";
        echo "<tr><td class='recipetitle' style='width:250px;align:left; background:#F4716A;'>"  . $row["title"]. "</td></tr>"; 
        echo "</table>";

        echo "<div align=center><a href=\"$link_address\"><img style='width:250px;' src=\"../images/Braciola-de-Pollo.jpg\" alt=\"bla bla\" ></a></div>";     	
        echo "<a href=\"$link_address\">See more</a>";
	echo "</table>";
	echo "</table></td></tr>";
    }
 ...
 while($row=mysql_fetch_array($result_set))
 {
  ?>
	...
	<table style="padding-right:25px;">
        <tr>
        <td  style="height:62px;width:200px;padding:10px;text-align:center;background:rgb(236, 77, 69) none repeat scroll 0% 0%;color:white" ><?php echo $row['title'] ?></td>
        </tr>
        <tr>
        <td style="text-align:center"><a href="view.php"><img style="width:220px;height:200px" src="uploads/<?php echo $row['file'] ?>" ></a></td>
        </tr>
        </table></ br>
        </div>
        </center>
...
function getData(idtosend){
    $.post('view.php', id: idtosend, function (response){
					...
					<div class="cwrap">
						...
						<div class="entries row">
							...
							<div class="quicklinks">
								<a href="recipes2.html" class="button">More recipes</a>
				...
				<aside class="sidebar one-fourth">
					<div class="widget wow fadeInRight">
						...
						<ul class="boxed">
							...
							<li class="light"><a href="recipes.html" title="Cocktails"><i class="ico i-eggs"></i> <span>Eggs</span></a></li>
							
							
						
							<li class="medium"><a href="recipes.html" title="Fish"><i class="ico i-fish"></i> <span>Fish</span></a></li>
							
							<li class="dark"><a href="recipes.html" title="Asian"><i class="ico i-asian"></i> <span>Asian</span></a></li>
							<li class="light"><a href="recipes.html" title="Mexican"><i class="ico i-mexican"></i> <span>Mexican</span></a></li>
							
							<li class="medium"><a href="recipes.html" title="Meat"><i class="ico i-meat"></i> <span>Meat</span></a></li>
							<li class="dark"><a href="recipes.html" title="Snacks"><i class="ico i-snacks"></i> <span>Snacks</span></a></li>
							
							<li class="light"><a href="recipes.html" title="Salads"><i class="ico i-salads"></i> <span>Salads</span></a></li>
